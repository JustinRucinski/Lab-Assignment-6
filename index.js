 window.onload = function() {
    ...
    ScrollReveal().reveal('.image_4', {delay:500, distance: '500px', origin: 'top', rotate: {x: 45, y: 45, z: 45}});
    ScrollReveal().reveal('.image_5', {delay:500, distance: '500px', orgin: 'bottom', rotate: {x: 90, y: 90, z: 90}});
 }